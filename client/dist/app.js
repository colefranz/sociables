...
var _colefranz$sociables$Main$viewMessage = function (msg) {
	return A2(
...
var _colefranz$sociables$Main$serverAddress = 'ws://localhost:3000/';
var _colefranz$sociables$Main$Model = F2(
	function (a, b) {
		return {input: a, messages: b};
	});
var _colefranz$sociables$Main$init = {
	ctor: '_Tuple2',
	_0: A2(
		_colefranz$sociables$Main$Model,
		'',
		{ctor: '[]'}),
	_1: _elm_lang$core$Platform_Cmd$none
};
var _colefranz$sociables$Main$update = F2(
	function (msg, _p0) {
		var _p1 = _p0;
		...
		switch (_p2.ctor) {
			case 'Input':
				return {
					ctor: '_Tuple2',
					_0: A2(_colefranz$sociables$Main$Model, _p2._0, _p4),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Send':
				return {
					ctor: '_Tuple2',
					_0: A2(_colefranz$sociables$Main$Model, '', _p4),
					_1: A2(_elm_lang$websocket$WebSocket$send, _colefranz$sociables$Main$serverAddress, _p3)
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _colefranz$sociables$Main$NewMessage = function (a) {
	return {ctor: 'NewMessage', _0: a};
};
var _colefranz$sociables$Main$subscriptions = function (model) {
	return A2(_elm_lang$websocket$WebSocket$listen, _colefranz$sociables$Main$serverAddress, _colefranz$sociables$Main$NewMessage);
};
var _colefranz$sociables$Main$Send = {ctor: 'Send'};
var _colefranz$sociables$Main$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _colefranz$sociables$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				A2(_elm_lang$core$List$map, _colefranz$sociables$Main$viewMessage, model.messages)),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_colefranz$sociables$Main$Input),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_colefranz$sociables$Main$Send),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _colefranz$sociables$Main$main = _elm_lang$html$Html$program(
	{init: _colefranz$sociables$Main$init, view: _colefranz$sociables$Main$view, update: _colefranz$sociables$Main$update, subscriptions: _colefranz$sociables$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _colefranz$sociables$Main$main !== 'undefined') {
    _colefranz$sociables$Main$main(Elm['Main'], 'Main', undefined);
}
